...
export function LegacyUsers() {
  ...
  return (
    <div>
      ...
      <div className="mb-6 flex items-start gap-3 rounded-2xl border border-amber-200/80 bg-amber-50 px-4 py-4 text-[13px] leading-relaxed text-amber-900 shadow-sm sm:px-5">
