...
public class InternalClientAuthenticationFilter extends OncePerRequestFilter {
    ...
    private static final String KEY_HEADER = "X-Internal-Service-Key";
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        String supplied = request.getHeader(KEY_HEADER);
        ...
        var authentication = new UsernamePasswordAuthenticationToken(
                CLIENT_ID, null, List.of(new SimpleGrantedAuthority("ROLE_INTERNAL_SERVICE")));
